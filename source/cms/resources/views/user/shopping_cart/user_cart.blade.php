    ...
    <div class="main-wrapper">
        <div class="container">
            <div class="content">
                <div class="col-sm-12">
                    <div class="cart-form">
                        <div class="section col-sm-12 col-md-12 col-lg-12 nopadding ">
                            <h2 style="margin-bottom: 60px">{{@trans("pages.shopping_cart.your_cart")}}</h2>
                            <h4 class="text-left">{{@trans("pages.shopping_cart.your_cart_description")}} {{CommonService::formatPriceBaseCodeExchange(500,$currencyCode,$exchangeRate)}} &nbsp;</h4>
                            ...
                            <div class="col-sm-5 col-md-5 col-lg-4 nopadding">
                                ...
                                <div class="cart-submit btn-list">
                                    ...
                                    <div class="col-sm-6 nopadding cart">
                                        ...
                                        <input class="btn btn-default col-sm-4" id="btn-checkout" type="submit"
                                        value="{{@trans('pages.shopping_cart.checkout')}}" onclick="validOrderCart()"/>
                                    </div>
                                </div>
