...
@section('content')
    <div class="row bg-title">
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title">How It Works [ {{ $total }} ]</h4>
        </div>
                ...
                <div class="table-responsive">
                    <div class="dataTables_wrapper no-footer">
                        <div class="dataTables_length">
                            <label>
                                <a href="{{ url('/admin/home-how-it-works/create') }}" class="btn btn-success pull-left"
                        ...
                        <div class="dataTables_filter">
                            {!! Form::open(['method' => 'GET', 'url' => '/admin/home-how-it-works', 'class' => '', 'role' => 'search'])  !!}
                        ...
                        <table class="table table-borderless table-striped">
                            ...
                            <tbody>
                            @foreach($homeHowItWorks as $work)
                                <tr>
                                    <td class="hidden-xs"><img class="img img-responsive" src="{{ asset($work->imageUrl()) }}" width="80px" ></td>
                                    <td>{{ $work->title_en }}</td>
                                    <td>{!! $work->description_en !!}</td>
                                    <td>{{ $work->status() }}</td>
                                    <td class="text-center text-nowrap">
                                        <a href="{{ url('/admin/home-how-it-works/' . $work->id) }}"
                                           data-toggle="tooltip"
                                           title="View" data-animation="false">
                                            <i class="fa fa-eye text-inverse m-l-5 m-r-5"></i>
                                        </a>
                                        <a href="{{ url('/admin/home-how-it-works/' . $work->id . '/edit') }}"
                                           data-toggle="tooltip" title="Edit" data-animation="false">
                                            <i class="fa fa-pencil-square-o text-inverse m-l-5 m-r-5"></i>
                                        </a>
                                        {!! Form::open([
                                            'method'=>'DELETE',
                                            'url' => ['/admin/home-how-it-works', $work->id],
                        ...
                        <div class="dataTables_paginate paging_simple_numbers">
                            {!! $homeHowItWorks->appends(['q' => Request::get('q')])->render() !!}
                        </div>
                    </div>
                </div>
