...
<div class="form-group row {{ $errors->has('image') ? 'has-error' : ''}}">
    <label for="slider_img" class="col-md-3 col-sm-5 col-form-label">Image <span class="text-danger"></span></label>
    <div class="col-md-9 col-sm-7">
        <div class="text-wrapper">
            <img src="{{ isset($sliderUrl) ? $sliderUrl : url(config('constants.SLIDER_DEFAULT_IMG')) }}" id="output"
