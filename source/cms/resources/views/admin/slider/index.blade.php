...
@section('content')
    <div class="row bg-title">
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title">Sliders [ {{$total}} ] </h4>
        </div>
        ...
        <div class="table-responsive">
            <div class="dataTables_wrapper no-footer">
                <div class="dataTables_length">
                    <label>
                        <a href="{{ url('/admin/slider/create') }}" class="btn btn-success pull-left">
                ...
                <table class="table table-hover">
                    ...
                    @foreach($slider as $item)
                        <tr>
                            <td class="hidden-xs">
                                <img src="{{ $item->sliderUrl() }}" width="100px" height="60px"
                            ...
                            <td class="text-center text-nowrap">
                                <a href="{{ url('/admin/slider/' . $item->id) }}" data-toggle="tooltip"
                                ...
                                <a href="javascript:void(0);" data-toggle="tooltip" title="Delete"
                                   ...
                                   onclick="confirmSubmit(event, this, 'Delete Slider', 'Do you want to delete this slider?')">
                ...
                <div class="dataTables_paginate paging_simple_numbers">
                    {!! $slider->appends(['q' => Request::get('q')])->render() !!}
                </div>
            </div>
        </div>
    </div>
