...
@section('content')
    <div class="row bg-title">
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title"> Shoe Sizes [ {{$total}} ] </h4>
        </div>
        <div class="col-lg-8 col-sm-8 col-md-8 col-xs-12">
            <ol class="breadcrumb">
                <li><a href="{{ url('/admin') }}">Admin</a></li>
                <li class="active"> Shoes Sizes</li>
            </ol>
        </div>
    </div>
    <div class="white-box">
        <div class="table-responsive">
            <div class="dataTables_wrapper no-footer">
                <div class="dataTables_length">
                    <label>
                        <a href="{{ url('/admin/shoe-sizes/create') }}" class="btn btn-success pull-left">
                    ...
                    @foreach($shoeSizes as $item)
                        <tr>
                            ...
                            <td class="text-center text-nowrap">
                                <a href="{{ url('/admin/shoe-sizes/' . $item->id) }}" data-toggle="tooltip"
                                   title="Show" data-animation="false">
                                    <i class="fa fa-eye text-inverse m-l-5 m-r-5"></i>
                                </a>

                                <a href="{{ url('/admin/shoe-sizes/' . $item->id . '/edit') }}"
                ...
                <div class="dataTables_paginate paging_simple_numbers">
                    {!! $shoeSizes->appends(['q' => Request::get('q')])->render() !!}
                </div>
            </div>
        </div>
    </div>
