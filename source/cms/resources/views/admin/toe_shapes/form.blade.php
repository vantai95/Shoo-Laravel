<div class="form-group row {{ $errors->has('shoe_category_ids') ? 'has-error' : ''}}">
    <label for="shoe_category_ids" class="col-md-3 col-sm-5 col-form-label">Categories <span
                class="text-danger">*</span></label>
    <div class="col-md-5 col-sm-5">
        {!! Form::select('shoe_category_ids[]', \App\Models\ShoeCategory::pluck('name_en', 'id'),isset($toeShape)?$toeShape->categories->pluck('id'):null, ['class' => 'form-control', 'multiple' => 'multiple', 'id' =>'shoe_category_ids']) !!}
...
<div class="form-group row {{ $errors->has('picture') ? 'has-error' : ''}}">
    ...
    <div class="col-md-9 col-sm-7">
        <div class="text-wrapper">
            <img src="{{ isset($imageUrl) ? $imageUrl : url(config('constants.TOE_SHAPE_DEFAULT_IMG')) }}" id="output"
            ...
            <button onclick="uploadFile($('#picture'))" type="button" class="btn btn-default"><i
