<div class="form-group row {{ $errors->has('shoe_category_ids') ? 'has-error' : ''}}">
    ...
    <div class="col-md-5 col-sm-5">
        {!! Form::select('shoe_category_ids[]', \App\Models\ShoeCategory::pluck('name_en', 'id'),isset($leather)?$leather->categories->pluck('id'):null, ['class' => 'form-control', 'multiple' => 'multiple', 'id' =>'shoe_category_ids']) !!}
...
<div class="form-group row {{ $errors->has('color_en') ? 'has-error' : ''}}">
    <label for="color_en" class="col-md-3 col-sm-5 col-form-label">Color English<span class="text-danger">*</span></label>
    <div class="col-md-9 col-sm-7">
        {!! Form::text('color_en', null, ['class' => 'form-control']) !!}
        {!! $errors->first('color_en', '<p class="help-block">:message</p>') !!}
    </div>
</div>

<div class="form-group row {{ $errors->has('color_vi') ? 'has-error' : ''}}">
    <label for="color_vi" class="col-md-3 col-sm-5 col-form-label">Color Vietnamese<span class="text-danger">*</span></label>
    <div class="col-md-9 col-sm-7">
        {!! Form::text('color_vi', null, ['class' => 'form-control']) !!}
        {!! $errors->first('color_vi', '<p class="help-block">:message</p>') !!}
    </div>
</div>
...
<div class="form-group row {{ $errors->has('picture') ? 'has-error' : ''}}">
    ...
    <div class="col-md-9 col-sm-7">
        <div class="text-wrapper">
            <img src="{{ isset($imageUrl) ? $imageUrl : url(config('constants.LEATHER_DEFAULT_IMG')) }}" id="output" class="img img-responsive"/>
