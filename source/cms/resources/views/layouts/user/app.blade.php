...
<head>
    ...
    <meta property="og:title"
          content="ShoeX - Custom fit shoes | Handcrafted dress shoes | ShoeX Shoes | Start from $299 USD only on INDIEGOGO."/>
    ...
    <link href="{{ asset('theme/user/css/intlTelInput.css') }}" rel="stylesheet">
...
<script src="{{ asset('theme/user/js/intlTelInput.js') }} "></script>
<script src="{{ asset('theme/user/js/countries.js') }}"></script>
<script src="{{ asset('theme/user/js/stl_viewer.min.js') }}"></script>
