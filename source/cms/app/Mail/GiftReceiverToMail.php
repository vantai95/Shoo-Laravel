...
class GiftReceiverToMail extends Mailable
{
    ...
    public function __construct($data)
    {
        ...
        $email = EmailTemplate::where('name', 'order.readytowear.giftreceiver')->select('email_templates.*', "subject_$language as subject", "content_$language as content")->firstOrFail();
        ...
        $this->params = ['content' =>$email->parse([
                                                    ...
                                                    'billing_info' => $this->data['billing_info'],
