...
class OrderBuyToMail extends Mailable
{
    ...
    public function __construct($data)
    {
        ...
        $email = EmailTemplate::where('name', 'order.readytowear.buy')->select('email_templates.*', "subject_$language as subject", "content_$language as content")->firstOrFail();
